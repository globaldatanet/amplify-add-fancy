...
const cloneSecretsOnEnvInitHandler = async (context, sourceEnv, destEnv) => {
    ...
    const functionsWithSecrets = functionNames.filter(name => !!functionSecretsStateManager_1.getLocalFunctionSecretNames(name).length);
    ...
    const funcSecretDeltas = await secretValuesWalkthrough_1.cloneEnvWalkthrough(!((_c = (_b = context === null || context === void 0 ? void 0 : context.exeInfo) === null || _b === void 0 ? void 0 : _b.inputParams) === null || _c === void 0 ? void 0 : _c.yes), cloneDeltas);
