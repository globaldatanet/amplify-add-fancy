...
class LayerCloudState {
    ...
    async loadLayerDataFromCloud(context, layerName) {
        ...
        try {
            ...
            const layerStacks = (_a = stackList === null || stackList === void 0 ? void 0 : stackList.StackResourceSummaries) === null || _a === void 0 ? void 0 : _a.filter(stack => stack.LogicalResourceId.includes(layerName));
