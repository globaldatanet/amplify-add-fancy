...
function getSanityCheckRules(isNewAppSyncAPI, ff) {
    let diffRules = [];
    let projectRules = [];
    if (!isNewAppSyncAPI) {
        if (ff.getBoolean('enableIterativeGSIUpdates')) {
            diffRules.push(sanity_check_1.cantEditKeySchemaRule, sanity_check_1.cantAddLSILaterRule, sanity_check_1.cantRemoveLSILater, sanity_check_1.cantEditLSIKeySchemaRule);
            projectRules.push(sanity_check_1.cantHaveMoreThan500ResourcesRule);
        }
        else {
            diffRules.push(sanity_check_1.cantEditKeySchemaRule, sanity_check_1.cantAddLSILaterRule, sanity_check_1.cantRemoveLSILater, sanity_check_1.cantEditLSIKeySchemaRule, sanity_check_1.cantEditGSIKeySchemaRule, sanity_check_1.cantAddAndRemoveGSIAtSameTimeRule);
